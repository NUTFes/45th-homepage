...
export default function PcLogoInfo() {
  return (
    <section aria-label="技大祭について" className="flex w-full items-center justify-center gap-pm bg-linear-to-b from-[#FFFAFA] from-[8.17%] via-[#9399C7] via-[54.81%] to-base px-pll py-ll">

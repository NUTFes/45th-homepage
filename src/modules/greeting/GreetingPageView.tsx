      ...
      <div className="relative overflow-hidden">     
        ...
        <div className="relative z-10 flex flex-col gap-y-5l py-5l">
          <div className="flex flex-col gap-y-ll">
            <div className="px-pl"><SectionTitle title="学長挨拶"/> </div>                  
            <GreetingSection
              name="鎌土重晴"
        ...
        <div className="flex flex-col gap-y-ll">
          <div className="px-pl"><SectionTitle title="実行委員長挨拶"/> </div>
        <GreetingSection
          name="齊藤　翔太"
          nameEng="SHOTA SAITO"
  ...
  return (
   <div className="relative min-h-screen bg-base pb-pm">
      <ThemeSection />
        ...
        <div className="relative z-10 flex flex-col gap-y-5l py-5l">
          <div className="flex flex-col gap-y-ll">
            <div><SectionTitle title="学長挨拶"/> </div>                  
            <GreetingSection
              name="鎌土重晴"
              nameEng="SHIGEHARU KAMADO"
              imageSrc="/image/greeting/picture_kamado.png"
        ...
        <div className="flex flex-col gap-y-ll">
          <div><SectionTitle title="実行委員長挨拶"/> </div>
        <GreetingSection
          name="齊藤　翔太"
          nameEng="SHOTA SAITO"
          imageSrc="/image/greeting/picture_shota.png"
...
export default function GreetingPageView(){
  return(
        <div>
          <div className="hidden md:flex"><GreetingPagePCView/></div>
          <div className="md:hidden"><GreetingPageMobileView/></div>
        </div>

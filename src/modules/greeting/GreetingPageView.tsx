  ...
  return (
    <div className="relative min-h-screen bg-base pb-pm">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-y-5l py-5l md:py-5l">
          {greetingEntries.map(({ title, ...greetingProps }) => (
            <div key={title} className="flex flex-col gap-y-ll">
              <div className="px-0 md:px-pl">

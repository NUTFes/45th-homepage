...
export default function AccessPageView() {
  return (
    <div className="flex min-h-screen flex-col gap-y-4l bg-base text-white py-4l">
        ...
        <InfoFrame className="flex w-full flex-col text-center gap-y-s mb:px-pll px-8">
            ...
            <div className="mb:text-Ptitle-small text-button">9月19日（土）　10：00～20：00 </div>
            <div className="mb:text-Ptitle-small text-button">9月20日（日）　10：00～18：30 </div>
            <div className="mb:text-textb text-text">※1日目の出店は17：00まで、2日目の出店は16：00までです</div>
        </InfoFrame>

        <div className="flex flex-col gap-y-m">
            <SectionTitle title="シャトルバス時刻表" /> 
            <div className="mb:text-textb text-text px-3l">
...
<p>乗り場周辺には、技大祭Tシャツを着たスタッフがおりますので、場所がわからない場合はお気軽にお声がけください。</p>
            ...
            <div className="bg-base-dark flex flex-col gap-y-m py-l">
                <div className=" w-full px-ll flex flex-col gap-y-xs">
                    <div className="underline underline-secondary text-title-small">実施日</div>
        ...
        <div className="flex flex-col gap-y-m">
             ...
             <div className="text-text flex flex-col px-ll ">
         ...
         <div className="flex flex-col gap-y-m">
            ...
            <div className="text-text flex flex-col px-ll text-center justify-center gap-y-ss">
                <div className="mb:text-Ptitle-small text-button ">駐車場マップ</div>
                    <div>画像</div>

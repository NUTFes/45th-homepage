      ...
      <div className="relative z-10 flex flex-col gap-y-4l md:gap-y-pm md:py-4l">
          ...
          <div className="z-10 flex w-full flex-col justify-center gap-y-4l md:mx-auto md:max-w-200">
            <div className="flex flex-col gap-y-ss md:gap-y-s">
              ...
              <div className="flex justify-center px-8 md:px-0">
                <iframe
                  className="z-10 aspect-4/3 w-full max-w-4xl border-2 border-main md:max-w-none"
                  src={UNIVERSITY_MAP_URL}
              ...
              <div className="relative">
                ...
                <InfoFrame className="relative z-10 flex flex-col gap-y-s px-8 text-center md:px-4l">
                  <div className="flex flex-col gap-y-s">
                    ...
                    <div className="text-button md:text-Ptitle-small">
                      9月19日（土）　10：00～20：00
                    </div>
                    <div className="text-button md:text-Ptitle-small">
                      9月20日（日）　10：00～18：30
                    </div>
                    <div className="text-start text-text md:text-textb">
        ...
        <section className="flex flex-col gap-y-m">
          ...
          <Image
            ...
            height={598}
            sizes="100vw"
            className="mx-auto h-auto w-full max-w-none px-l md:max-w-188.5 md:px-0"
          />
        </section>

        <section className="flex flex-col gap-y-m bg-base-dark py-l">
          <div className="flex w-full flex-col gap-y-xs px-ll md:px-pll">
            <div className="underline-secondary text-title-small underline md:text-Ptitle-small">
              シャトルバス実施日
            </div>
        ...
        <section className="flex flex-col gap-y-m">
          ...
          <div className="flex flex-col px-ll text-text md:px-pll md:text-Ptext">
          ...
          <Image
            ...
            className="mx-auto h-auto w-full max-w-none px-l md:max-w-188.5 md:px-0"
          />
          <div className="flex justify-center px-ll text-center text-text md:px-pll">

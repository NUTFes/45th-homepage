    ...
    <footer className="bg-secondary px-m py-m text-black">
      <div className="mx-auto flex w-full max-w-[393px] flex-col items-center gap-ll">
        <section aria-label="SNS" className="flex flex-col items-center gap-xs">
          <h2 className="font-kaisotai text-title leading-[1] font-semibold">FOLLOW US</h2>
          <Image
            alt="Instagram"
            className="size-10"
            height={40}
        ...
        <section className="leading-text flex w-full max-w-[272px] flex-col gap-xs text-text">
        ...
        <p className="leading-text text-center text-text">技大祭実行委員会</p>
      </div>
    </footer>
  );
}
